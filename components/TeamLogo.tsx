...
export function TeamLogo({ logoUrl, name, tag, className = "w-full h-full" }: TeamLogoProps) {
  ...
  if (!hasLogo || hasError) {
    ...
    return (
      <div className={`bg-[#151515] border border-white/10 flex flex-col items-center justify-center text-center select-none w-full h-full p-2 shadow-inner ${className}`}>
        <div className="w-10 h-10 bg-white/5 border border-white/20 flex items-center justify-center mb-2 shadow-inner">
